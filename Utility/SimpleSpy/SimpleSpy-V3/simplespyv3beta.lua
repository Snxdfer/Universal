...
local Highlight = (isfile and loadfile and isfile("Highlight.lua") and loadfile("Highlight.lua")()) or loadstring(game:HttpGet("https://raw.githubusercontent.com/Snxdfer/Universal/refs/heads/main/Utility/SimpleSpy/SimpleSpy-V3/highlight.lua"))()
local LazyFix = loadstring(game:HttpGet("https://raw.githubusercontent.com/Snxdfer/Universal/refs/heads/main/Utility/SimpleSpy/SimpleSpy-V3/DataToCode.lua"))() -- Very lazy fix as I'm legit just pasting it from the rewrite
...
if not getgenv().SimpleSpyExecuted then
    local succeeded,err = pcall(function()
        ...
        logthread(spawn(function()
            local suc,err = pcall(game.HttpGet,game,"https://raw.githubusercontent.com/Snxdfer/Universal/refs/heads/main/Utility/SimpleSpy/SimpleSpy-V3/update.txt")
...
if configs.supersecretdevtoggle then
    ...
    function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Snxdfer/Universal/refs/heads/main/Utility/SimpleSpy/SS-V2.2/src.lua"))()
    end)
    newButton("Load SSV3",function()
        return "Load's Simple Spy V3"
    end,
    function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Snxdfer/Universal/refs/heads/main/Utility/SimpleSpy/SimpleSpy-V3/v3-src.lua"))()
    end)
